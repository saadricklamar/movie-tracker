...
describe('fetchData', () => {
    ...
    describe('addUser', () => {
      it('calls fetch with the correct data when adding a new user', async () => {
        ...
        const mockUser = { name: 'Bridgett', email: 'bac@gmail.com', password: 'Gus'}
    ...
    describe('addFavorite', () => {
      it('calls fetch with the correct parameters when adding a new favorite', async () => {
        ...
        const movie = {title: 'Avengers', poster_path: 'posterImage', release_date: 2019, vote_average: 10, overview: 'synopsis'}
        const movie_id = 1
        const user_id = 2
